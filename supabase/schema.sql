...
-- 3. INDEX SPASIAL & PENCARIAN CEPAT
...
-- 4. AKTIFKAN ROW LEVEL SECURITY (RLS) DENGAN AKSES ANOM/PUBLIC READ & WRITE
ALTER TABLE public.poles ENABLE ROW LEVEL SECURITY;
ALTER TABLE public.users ENABLE ROW LEVEL SECURITY;

-- Izinkan akses baca publik untuk aplikasi Web GIS
...
-- 5. SEED DATA AKUN RESMI DISKOMINFOTIKSAN
