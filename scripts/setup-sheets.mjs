...
const MASTER_PROVIDERS = [
  [
    ...
    '#ef4444',
    'ACTIVE',
    'No. 1: Tiang hitam sabuk Merah & Abu-abu di tengah',
  ],
  [
    'PRV_MNC_1',
    '2. MNC PLAY (Tipe A)',
    ...
    '#475569',
    'ACTIVE',
    'No. 2: Tiang hitam berundak dengan 2 garis strip putih di bawah',
  ],
  [
    'PRV_FIRSTMEDIA',
    '3. FIRST MEDIA',
    ...
    '#16a34a',
    'ACTIVE',
    'No. 3: Tiang galvanis abu-abu polos dengan pucuk Hijau cerah',
  ],
  [
    'PRV_MNC_2',
    '4. MNC PLAY (Tipe B)',
    ...
    '#475569',
    'ACTIVE',
    'No. 4: Tiang hitam panjang dengan 2 garis strip putih di bawah',
  ],
  [
    'PRV_BIZNET',
    '5. BIZNET NETWORKS',
    ...
    '#f97316',
    'ACTIVE',
    'No. 5: Tiang hitam dengan gelang Kuning & Hitam di pucuk',
  ],
  [
    'PRV_MORATEL_1',
    '6. MORATELINDO (Bawah Kuning)',
    'MORA',
    '#eab308',
    'ACTIVE',
    'No. 6: Tiang hitam berundak dengan blok Kuning di bagian bawah',
  ],
  [
    'PRV_IFORTE',
    '7. IFORTE',
    ...
    '#3b82f6',
    'ACTIVE',
    'No. 7: Tiang hitam gelang kombinasi Biru - Putih - Biru di pucuk',
  ],
  [
    'PRV_LINTASARTA',
    '8. LINTASARTA (LA)',
    ...
    '#0ea5e9',
    'ACTIVE',
    'No. 8: Tiang hitam blok Biru Muda di tengah & label teks LA di bawah',
  ],
  [
    'PRV_MSA',
    '9. MSA (Megasurya Angkasa)',
    'MSA',
    '#38bdf8',
    'ACTIVE',
    'No. 9: Tiang hitam strip Biru di pucuk & label teks MSA',
  ],
  [
    'PRV_FIBERSTAR',
    '10. FIBERSTAR',
    ...
    '#06b6d4',
    'ACTIVE',
    'No. 10: Tiang hitam blok Biru Langit di tengah & label teks FS',
  ],
  [
    'PRV_XL_1',
    '11. XL AXIATA (Biru Polos)',
    'XL',
    '#2563eb',
    'ACTIVE',
    'No. 11: Tiang hitam dengan blok Biru XL di tengah',
  ],
  [
    'PRV_INDOSAT',
    '12. INDOSAT OOREDOO',
    ...
    '#eab308',
    'ACTIVE',
    'No. 12: Tiang hitam sabuk Kuning Indosat di tengah',
  ],
  [
    'PRV_TBG',
    '13. TBG (Tower Bersama Group)',
    'TBG',
    '#22c55e',
    'ACTIVE',
    'No. 13: Tiang hitam dengan sabuk Hijau Muda di bagian bawah',
  ],
  [
    'PRV_MORATEL_2',
    '14. MORATELINDO (Sabuk Kuning)',
    'MORA',
    '#eab308',
    'ACTIVE',
    'No. 14: Tiang hitam dengan sabuk Kuning Moratel di tengah',
  ],
  [
    'PRV_SMARTFREN',
    '15. SMARTFREN TELECOM',
    'SMART',
    '#ec4899',
    'ACTIVE',
    'No. 15: Tiang hitam pucuk Merah Muda / Magenta Smartfren',
  ],
  [
    'PRV_CBN',
    '16. CBN FIBER',
    ...
    '#f97316',
    'ACTIVE',
    'No. 16: Tiang hitam blok Oranye Terang CBN di tengah',
  ],
  [
    'PRV_BALITOWER',
    '17. BALI TOWERINDO',
    ...
    '#8b5cf6',
    'ACTIVE',
    'No. 17: Tiang hitam blok Ungu Bali Tower di tengah',
  ],
  [
    'PRV_PLN_ICON',
    '18. PLN ICON PLUS (ICONNET)',
    'ICON',
    '#0284c7',
    'ACTIVE',
    'No. 18: Tiang beton/besi PLN Iconnet gelang Biru PLN',
  ],
  [
    'PRV_XL_2',
    '19. XL HOME FIBER (Sabuk Kuning)',
    'XL',
    '#2563eb',
    'ACTIVE',
    'No. 19: Tiang hitam gelang Biru XL & Kuning di pucuk',
  ],
  [
    'PRV_MYREPUBLIC',
    '20. MYREPUBLIC INDONESIA',
    'MYREP',
    '#9333ea',
    'ACTIVE',
    'No. 20: Tiang hitam gelang Ungu Magenta di pucuk',
  ],
  [
    'PRV_PJU_PEMKOT',
    'PJU PEMERINTAH KOTA LUBUKLINGGAU',
    'PJU',
    '#f59e0b',
    'ACTIVE',
    'Tiang Penerangan Jalan Umum (PJU) Mandiri milik Pemkot Lubuklinggau',
  ],
  [
    'PRV_PLN_PJU_GABUNG',
    'PLN + PJU (TIANG GABUNGAN)',
    'PLN+PJU',
    '#0ea5e9',
    'ACTIVE',
    'Tiang distribusi listrik PLN yang ditumpangi instalasi lampu PJU jalan',
  ],
  [
    'PRV_PLN_DISTRIBUSI',
    ...
    '#0284c7',
    'ACTIVE',
    'Tiang distribusi jaringan kabel listrik tegangan rendah/menengah PLN',
  ],
];
