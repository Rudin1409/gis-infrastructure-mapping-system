...
export const DEFAULT_ACCOUNTS: (AuthUser & { password: string; alternativeEmails?: string[] })[] = [
  ...
  {
    id: 'USR-SURVEYOR-05',
    email: 'frans.ahmad@lubuklinggaukota.go.id',
    password: 'surveyor123',
    name: 'Frans Ahmad Zhafif',
    role: 'SURVEYOR',
    roleLabel: 'Petugas Survei Spasial & Pemetaan',
    agency: 'Dinas Komunikasi, Informatika, Statistik dan Persandian Kota Lubuklinggau',
    team: 'KOMINFO',
    ...
    avatar: '👨‍💼',
    alternativeEmails: [
      'frans@lubuklinggaukota.go.id',
      'frans.zhafif@lubuklinggaukota.go.id',
      'fransahmad',
      'franszhafif',
      'frans',
      'frans ahmad zhaaif',
  ...
  {
    id: 'USR-SURVEYOR-06',
    email: 'm.fadlil@lubuklinggaukota.go.id',
    password: 'surveyor123',
    name: 'M. Fadlil',
    role: 'SURVEYOR',
    roleLabel: 'Petugas Survei Spasial & Pemetaan',
    ...
    avatar: '👨‍💼',
    alternativeEmails: [
      'fadlil@lubuklinggaukota.go.id',
      'mfadlil@lubuklinggaukota.go.id',
      'fadlil',
      'mfadlil',
      'm fadlil',
    ],
  ...
  {
    id: 'USR-SURVEYOR-07',
    email: 'rifqi@lubuklinggaukota.go.id',
    password: 'surveyor123',
    name: 'M. Rifqi',
    role: 'SURVEYOR',
    roleLabel: 'Petugas Survei Spasial & Pemetaan',
    ...
    avatar: '👨‍💼',
    alternativeEmails: [
      'm.rifqi@lubuklinggaukota.go.id',
      'mrifqi@lubuklinggaukota.go.id',
      'rifqi',
      'mrifqi',
      'm rifqi',
    ],
